public class Task_7 {
    ...
    public static void main(String[] args) {
        ...
        int[] averageDays = {workout200GramPerDay, workout500GramPerDay};
        double Average = java.util.Arrays.stream(averageDays).average().orElse(0);
        System.out.println("Среднее количество " + (int)Average + " дней");
    }
}
